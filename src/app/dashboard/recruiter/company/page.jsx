...
export default function CompanyProfile() {
  ...
  const [company, setCompany] = useState(null); // Explicit structure: { name, industry, websiteUrl, location, employeeCount, logo, description, status: 'Pending' | 'Approved' | 'Rejected' }
