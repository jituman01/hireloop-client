            ...
            <div className="relative z-10 mx-auto max-w-7xl px-6 ">
                ...
                <div className="mt-20 grid gap-6 md:grid-cols-2 lg:grid-cols-4 ">
                    {stats.map((stat) => (
                        <div
                            key={stat.id}
                            className="group relative overflow-hidden rounded-3xl border border-white/10 bg-black/60 p-8 backdrop-blur-xl transition duration-300 hover:border-violet-500/30"
                        >
                            {/* Card Glow */}
